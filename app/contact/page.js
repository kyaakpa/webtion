...
const Contact = () => {
  ...
  return (
    ...
    >
      <Head>
        <link rel="preload" href="/waving.webp" as="image" />
      </Head>
      <div>
        <Image
          src={humanImage}
        ...
        <svg
          ...
          className="absolute w-[700px] top-[150px] -left-20 -z-10  lg:block hidden"
        >
          <path
            fill="#fad4fa"
      ...
      <div className="flex flex-col gap-8 self-center rounded-2xl p-6 sm:w-[450px]">
