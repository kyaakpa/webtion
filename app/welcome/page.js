  ...
  return (
    <div className="flex flex-col items-center mt-24 gap-4 max-h-screen max-w-screen bg-black">
      <div className="relative w-full max-w-lg z-20">
        <div className="absolute top-0 -left-4 w-[600px] h-[600px] bg-pink-600 rounded-full mix-blend-multiply filter blur-2xl opacity-10 animate-blob"></div>
        <div className="absolute top-0 -right-4 w-[600px] h-[600px] bg-emerald-500 rounded-full mix-blend-multiply filter blur-2xl opacity-10 animate-blob animation-delay-2000"></div>
        <div className="absolute left-20 w-[600px] h-[600px] bg-blue-600 rounded-full mix-blend-multiply filter blur-2xl opacity-10 animate-blob animation-delay-4000"></div>
      </div>
